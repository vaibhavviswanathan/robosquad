...
mapSegmentCorners[54,1,1] = -9.63 - 0.29 - 3.16 - 0.29;
	...
	// Team Ben/Vicente/James/Da Eun ruuulez
	...
	//# coordinate for trash can in front of parsons entrance
	//# [21.16, -7.97] with radius of 0.356 m

	//# coordinate for personhole
	//# [39.65, -6.22] with radius of 0.356 m
	        ...
	        for (int i=0; i< numMapSegments; i++){
                ...
                mapSegmentCorners[i, 0, 0] += -16;
                mapSegmentCorners[i, 1, 0] += -16;
