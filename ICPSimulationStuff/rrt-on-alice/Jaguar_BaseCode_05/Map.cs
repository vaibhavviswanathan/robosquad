...
// added this pole in 
            /*
double pillarx = - 3.35 / 4;
mapSegmentCorners[122, 0, 0] = -0.34 / 2 + pillarx +3.35;
mapSegmentCorners[122, 0, 1] = -9.63 - 0.29;
mapSegmentCorners[122, 1, 0] = 0.34 / 2 + pillarx + 3.35;
mapSegmentCorners[122, 1, 1] = -9.63 - 0.29;

mapSegmentCorners[123, 0, 0] = -0.34 / 2 + pillarx + 3.35;
mapSegmentCorners[123, 0, 1] = -9.63 - 0.29;
mapSegmentCorners[123, 1, 0] = -0.34 / 2 + pillarx + 3.35;
mapSegmentCorners[123, 1, 1] = -9.63 - 0.29 - 0.29;

mapSegmentCorners[124, 0, 0] = -0.34 / 2 + pillarx + 3.35;
mapSegmentCorners[124, 0, 1] = -9.63 - 0.29 - 0.29;
mapSegmentCorners[124, 1, 0] = 0.34 / 2 + pillarx + 3.35;
mapSegmentCorners[124, 1, 1] = -9.63 - .29 - 0.29;

mapSegmentCorners[125, 0, 0] = 0.34 / 2 + pillarx + 3.35;
mapSegmentCorners[125, 0, 1] = -9.63 - 0.29;
mapSegmentCorners[125, 1, 0] = 0.34 / 2 + pillarx + 3.35;
mapSegmentCorners[125, 1, 1] = -9.63 - 0.29 - 0.29;
          */

double pillarx = -3.35 / 4;
mapSegmentCorners[122, 0, 0] = -0.34 / 2;
mapSegmentCorners[122, 0, 1] = -9.63 - 0.29 + 3.16;
mapSegmentCorners[122, 1, 0] = 0.34 / 2;
mapSegmentCorners[122, 1, 1] = -9.63 - 0.29 + 3.16;

mapSegmentCorners[123, 0, 0] = -0.34 / 2;
mapSegmentCorners[123, 0, 1] = -9.63 - 0.29 +3.16;
mapSegmentCorners[123, 1, 0] = -0.34 / 2;
mapSegmentCorners[123, 1, 1] = -9.63 - 0.29 - 0.29 + 3.16;

mapSegmentCorners[124, 0, 0] = -0.34 / 2;
mapSegmentCorners[124, 0, 1] = -9.63 - 0.29 - 0.29 + 3.16;
mapSegmentCorners[124, 1, 0] = 0.34 / 2;
mapSegmentCorners[124, 1, 1] = -9.63 - .29 - 0.29 + 3.16;

mapSegmentCorners[125, 0, 0] = 0.34 / 2;
mapSegmentCorners[125, 0, 1] = -9.63 - 0.29 + 3.16;
mapSegmentCorners[125, 1, 0] = 0.34 / 2;
mapSegmentCorners[125, 1, 1] = -9.63 - 0.29 - 0.29 + 3.16;
